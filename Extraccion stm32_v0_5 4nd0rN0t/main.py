...
# El archivo {filename} no existe. Sera Generado de 512 Kbytes lleno de 0xFF"
if not os.path.exists(filename):
        with open(filename, 'wb') as f:
            f.write(bytearray([0xff] * (512 * 1024)))
...
def write_to_specific_address(filename, address, data):
    ...
    with open(filename, 'r+b') as f:
        ...
        # Convierte el dato a bytes, se asume que es un entero de 4 bytes 'big o little'
